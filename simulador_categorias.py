def calculo_final_cupons(df,
    ...
    def calculo_tabela(df, agrupamento):
        ...
        if agrupamento == 'Total':
            ...
            ordem_colunas = [agrupamento, 'Total de Disparos','Uso de cupons','Taxa de Uso do Cupom','Margem Natural','Margem com Cupom','Redução de Margem','Margem Natural Media','Margem com Cupom Media','Diferença de Margem Media']
